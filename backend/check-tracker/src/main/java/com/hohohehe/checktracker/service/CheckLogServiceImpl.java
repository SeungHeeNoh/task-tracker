...
public class CheckLogServiceImpl implements CheckLogService {
    ...
    public void saveCheckLog(Long checkListId, LocalDate checkDate) {
        try {
            Optional<CheckLog> checkLog = checkLogRepository.findByCheckList_CheckListIdAndCheckDate(checkListId, checkDate);
            ...
            if (checkLog.isPresent()) {
                ...
                checkLogRepository.save(CheckLog.of(checkList, checkDate));
            }
    ...
    public void deleteCheckLog(Long checkListId, LocalDate checkDate) {
        ...
        if(checkLog.isPresent()) {
            checkLogRepository.delete(checkLog.get());
        } else {
